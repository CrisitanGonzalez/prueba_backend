...
@Configuration
@ComponentScan(basePackages = {"cl.gg2.haruna.security.controllers"})
@EnableSwagger2
public class SwaggerConfiguration {
    ...
    public Docket loginApi(ReloadableResourceBundleMessageSource messageSource) {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("gg2").apiInfo(apiInfo(messageSource))
    ...
    private ApiInfo apiInfo(ReloadableResourceBundleMessageSource messageSource) {
        return new ApiInfoBuilder().title("Login")
                .version("1.0.0")
                .description("Haruna api security").build();
    }
